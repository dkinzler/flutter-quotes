...
Tapping on a tag of a random quote on the explore screen will also take the user to the search screen and start a search with the selected tag as the query.
The straightforward way to implement these behaviours is by initiating the search in the onPressed callbacks of the search button and the quote tag, e.g.
...
Furthermore an Actions widget can be inserted into the widget tree, that definces which intents are performed by which actions. 
